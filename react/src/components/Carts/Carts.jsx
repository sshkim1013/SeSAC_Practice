  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        {/* <Product product={carts["products"][0]}></Product>
        <Product product={carts["products"][1]}></Product>
        <Product product={carts["products"][2]}></Product>
        <Product product={carts["products"][3]}></Product> */}

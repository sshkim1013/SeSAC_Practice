...
// async function getProductsReviews(id) {
...
// async function getReviewsRating(id) {
//   const response = await axios.get(`${BASE_URL}/products/${id}`);
//   const data = response["data"];
//   const reviews = data["reviews"];
...
// async function getPostsByTagList() {
...
// async function getPostBySpecificTag() {
//   const response = await axios.get(`${BASE_URL}/posts//tag/life`);
//   const data = response["data"];
//   console.log(data);
// }
// getPostBySpecificTag();
...
async function getTotalFromProductsByProductName() {
  const response = await axios.get(`${BASE_URL}/products/search?q=glass`);
  const data = response["data"];
  const total = data["total"];
  console.log(total);
}
getTotalFromProductsByProductName();

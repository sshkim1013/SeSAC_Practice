...
// async function getRecipeofLunchMealType() {
//   const config = {
//     url: `${BASE_URL}/recipes/meal-type/lunch`,
//     method: "GET",
//   };
...
//     data: { name: "Kimbap", cuisine: "Korean" },
//   };
//   const response = await axios(config);
//   const data = response["data"];
//   console.log(data);
...
// async function searchUserforName(name) {
//   const config = { url: `${BASE_URL}/users/search?q=${name}`, method: "GET" };
//   const response = await axios(config);
//   const data = response["data"];
//   const users = data["users"];
//   console.log(users);
// }
// searchUserforName("anna");
...
//   const config = { url: `${BASE_URL}/users/${id}/todos`, method: "GET" };
//   const response = await axios(config);
//   const data = response["data"];
...
async function getElementsOfAllComments() {
  const config = { url: `${BASE_URL}/comments`, method: "GET" };
  const response = await axios(config);
  const data = response["data"];
  const comments = data["comments"];
  let result = comments.map(({ body, likes, user }) => {
    return { body, likes, username: user["username"] };
  });
  console.log(result);
}
getElementsOfAllComments();
